    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.next:
                ...
                intent2.setClass(historygame.this,game.class);
                startActivity(intent2);
                break;

            case R.id.dealtrule:

                LayoutInflater factory=LayoutInflater.from(historygame.this);
                final View v1=factory.inflate(R.layout.dealt_card_rules,null);

                AlertDialog.Builder inputDialog =
                        new AlertDialog.Builder(historygame.this);
            ...
            case R.id.wagerrule:
                ...
                LayoutInflater factory2=LayoutInflater.from(historygame.this);
